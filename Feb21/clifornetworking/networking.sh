...
gcloud compute networks create 'my-vpc-from-cli' --subnet-mode 'custom' 
...
gcloud compute networks subnets create web-uscentral1 --network my-vpc-from-cli  --range 192.168.1.0/24 --region us-central1
